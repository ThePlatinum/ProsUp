  ...
  return (
    <div className="App-Footer">
      <div className='Container'>
        <div> 
          ProsUp 2021 | <a href='/prosup-privacypolicies'className='privacy'>privacy policies</a><br />
          built by <a href='https://platinum-innovations.business.site' rel="noreferrer" target='_blank'>Platinum Innovations</a><br />
